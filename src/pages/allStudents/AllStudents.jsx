											...
											<tr key={index}>
												...
												<td className="">
													<button className="btn">
														<i
															className="bi bi-trash3 pe-auto text-danger"
													...
													<button className="btn">
														<i
															className="bi bi-pencil-square m-3 text-success"
															data-bs-toggle="modal"
															data-bs-target="#edit"
															onClick={() => {
																handleEdit(student);
				...
				<div className="modal-dialog">
					<div className="modal-content">
						...
						<div className="modal-body">
							<label
								htmlFor="basic-url"
								className="form-label  mt-4 fw-bold"
							>
								Full Name
							</label>
